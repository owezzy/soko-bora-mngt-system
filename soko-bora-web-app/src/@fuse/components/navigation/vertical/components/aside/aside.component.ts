...
export class FuseVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    @Input() autoCollapse: boolean | undefined;
    // @ts-ignore
    @Input() item: FuseNavigationItem;
    @Input() name: string | undefined;
    @Input() skipChildren: boolean | undefined;

    active: boolean = false;
    private _fuseVerticalNavigationComponent: FuseVerticalNavigationComponent | undefined;
    ...
    ngOnInit(): void
    {
        ...
        this._fuseVerticalNavigationComponent = this._fuseNavigationService.getComponent(<string>this.name);
