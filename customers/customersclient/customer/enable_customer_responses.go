...
func (o *EnableCustomerOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/customers/{id}/enable][%d] enableCustomerOK %s", 200, payload)
}
...
func (o *EnableCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/customers/{id}/enable][%d] enableCustomer default %s", o._statusCode, payload)
}
