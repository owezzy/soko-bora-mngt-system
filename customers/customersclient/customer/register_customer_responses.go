...
// Code gets the status code for the register customer o k response
func (o *RegisterCustomerOK) Code() int {
	return 200
}

func (o *RegisterCustomerOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/customers][%d] registerCustomerOK %s", 200, payload)
}
...
func (o *RegisterCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/customers][%d] registerCustomer default %s", o._statusCode, payload)
}
