...
// Code gets the status code for the disable customer o k response
func (o *DisableCustomerOK) Code() int {
	return 200
}

func (o *DisableCustomerOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/customers/{id}/disable][%d] disableCustomerOK %s", 200, payload)
}
...
func (o *DisableCustomerDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/customers/{id}/disable][%d] DisableCustomer default %s", o._statusCode, payload)
}
