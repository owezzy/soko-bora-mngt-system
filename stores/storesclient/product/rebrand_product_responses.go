...
func (o *RebrandProductOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/stores/products/{id}/rebrand][%d] rebrandProductOK %s", 200, payload)
}
...
func (o *RebrandProductDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/stores/products/{id}/rebrand][%d] rebrandProduct default %s", o._statusCode, payload)
}
