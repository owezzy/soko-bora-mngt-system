...
func (o *DecreaseProductPriceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/stores/products/{id}/decreasePrice][%d] decreaseProductPriceOK %s", 200, payload)
}
...
func (o *DecreaseProductPriceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/stores/products/{id}/decreasePrice][%d] decreaseProductPrice default %s", o._statusCode, payload)
}
