...
func (o *IncreaseProductPriceOK) Error() string {
	...
	return fmt.Sprintf("[PUT /api/stores/products/{id}/increasePrice][%d] increaseProductPriceOK %s", 200, payload)
}
...
func (o *IncreaseProductPriceDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /api/stores/products/{id}/increasePrice][%d] increaseProductPrice default %s", o._statusCode, payload)
}
