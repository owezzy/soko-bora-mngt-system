...
func (o *AuthorizePaymentOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/payments][%d] authorizePaymentOK %s", 200, payload)
}
...
func (o *AuthorizePaymentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/payments][%d] authorizePayment default %s", o._statusCode, payload)
}
