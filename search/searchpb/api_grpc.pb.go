...
const (
	...
	SearchService_GetDemoBootstrap_FullMethodName = "/searchpb.SearchService/GetDemoBootstrap"
)
...
type SearchServiceClient interface {
	...
	GetDemoBootstrap(ctx context.Context, in *GetDemoBootstrapRequest, opts ...grpc.CallOption) (*GetDemoBootstrapResponse, error)
}
...
func (c *searchServiceClient) GetDemoBootstrap(ctx context.Context, in *GetDemoBootstrapRequest, opts ...grpc.CallOption) (*GetDemoBootstrapResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetDemoBootstrapResponse)
	err := c.cc.Invoke(ctx, SearchService_GetDemoBootstrap_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SearchServiceServer interface {
	...
	GetDemoBootstrap(context.Context, *GetDemoBootstrapRequest) (*GetDemoBootstrapResponse, error)
...
func (UnimplementedSearchServiceServer) GetDemoBootstrap(context.Context, *GetDemoBootstrapRequest) (*GetDemoBootstrapResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDemoBootstrap not implemented")
}
...
func _SearchService_GetDemoBootstrap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetDemoBootstrapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SearchServiceServer).GetDemoBootstrap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SearchService_GetDemoBootstrap_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SearchServiceServer).GetDemoBootstrap(ctx, req.(*GetDemoBootstrapRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SearchService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDemoBootstrap",
			Handler:    _SearchService_GetDemoBootstrap_Handler,
		},
	},
